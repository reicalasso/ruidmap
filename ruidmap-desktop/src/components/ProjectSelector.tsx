...
export const ProjectSelector: React.FC<ProjectSelectorProps> = ({
  ...
  // Use the project search hook
  const { filteredItems: filteredProjects, updateFilters } = useProjectSearch(projects);

  useEffect(() => {
    loadProjects();
  }, []);

  // Update search filters when search term changes
  useEffect(() => {
    updateFilters({
      searchTerm: '',
      statusFilter: 'all',
          ...
          <div className="p-3 border-b border-gray-200 dark:border-gray-600">
            <div className="relative">
              ...
              <input
                ...
                className="w-full pl-10 pr-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md bg-white dark:bg-gray-700 text-gray-900 dark:text-white text-sm focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500"
